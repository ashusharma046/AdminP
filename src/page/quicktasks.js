...
export class QuickTasks extends React.Component {
  ...
  async onSwitchChange(index) { 
    ...
    try {
      const result = await fetch(`http://prod.7tvpyhipq3.us-east-2.elasticbeanstalk.com/updateShortCutsVisibilty`, {
        method: 'POST',
        headers: {
  ...
  componentDidMount() {
    const fetchData = async () => {
      try {
        const result = await fetch(`http://prod.7tvpyhipq3.us-east-2.elasticbeanstalk.com/getShortCuts`);
