...
export class Apps extends React.Component {
  ...
  componentDidMount() {
    const fetchData = async () => {
      try {
        const result = await fetch(`http://prod.7tvpyhipq3.us-east-2.elasticbeanstalk.com/apps`);
  ...
  async onSwitchChange(index) { 
    ...
    try {
      const result = await fetch(`http://prod.7tvpyhipq3.us-east-2.elasticbeanstalk.com/updateAppVisibilty`, {
        method: 'POST',
        headers: {
